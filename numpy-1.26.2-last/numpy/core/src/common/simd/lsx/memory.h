...
/*
		ptr[stride*0] = __lsx_vpickve2gr_w(a, 0);
...
NPY_FINLINE void npyv_storen_f32(float *ptr, npy_intp stride, npyv_f32 a)  //ok
...
/*
    union {unsigned long iv; double dv; } d;
	d.iv = __lsx_vpickve2gr_d(a, 0);
	ptr[stride*0] = d.dv;
	d.iv = __lsx_vpickve2gr_d(a, 1);
	ptr[stride*1] = d.dv;
*/
	}
...
/*
{
	ptr[stride*0] = __lsx_vpickve2gr_du(a, 0);
	ptr[stride*1] = __lsx_vpickve2gr_du(a, 1);
}*/
NPY_FINLINE void npyv_storen_s64(npy_int64 *ptr, npy_intp stride, npyv_s64 a)
{ npyv_storen_f64((double*)ptr, stride, (npyv_f64)a); }
/*
{
	ptr[stride*0] = __lsx_vpickve2gr_d(a, 0);
	ptr[stride*1] = __lsx_vpickve2gr_d(a, 1);
}
*/
...
//	ptr[stride*1] = __lsx_vpickve2gr_du(npyv_reinterpret_u64_u32(a), 1);
}
...
// two channels
/*
#define NPYV_IMPL_LSX_MEM_INTERLEAVE(SFX, T_PTR)                              \
...
//zn:TODO  sse 中 if 和 else 中一个是32bit，一个是16bit数据、高位补0
// uses vector as indexes into a table
