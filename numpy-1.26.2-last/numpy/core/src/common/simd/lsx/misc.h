...
#define npyv_zero_f32() (__m128)__lsx_vldi(0)  //zn:TODO ==> OK
...
#define npyv_setall_f32(VAL) (__m128)(v4f32){VAL, VAL, VAL, VAL}   //zn:TODO ==> OK
...
//		return __lsx_vxor_v(b, __lsx_vand_v(__lsx_vxor_v(b, a), mask)); 
}


 //zn:TODO 浮点的与或操作, =>已验证整数和浮点通用 ok
NPY_FINLINE __m128 npyv_select_f32(__m128i mask, __m128 a, __m128 b)
{ 
  return (__m128)__lsx_vbitsel_v((__m128i)b, (__m128i)a, mask);
//		return (__m128)__lsx_vxor_v((__m128i)b, __lsx_vand_v(__lsx_vxor_v((__m128i)b, (__m128i)a), mask));
}
...
//		return (__m128d)__lsx_vxor_v((__m128i)b, __lsx_vand_v(__lsx_vxor_v((__m128i)b, (__m128i)a), mask));
}
...
#define npyv_extract0_f32(A) A[0] //zn:TODO ==> OK
