...
#define npyv_and_f32(A, B)  \
        (__m128)__lsx_vand_v((__m128i)A, (__m128i)B)           //zn:TODO  => OK
#define npyv_and_f64(A, B)  \
        (__m128d)__lsx_vand_v((__m128i)A, (__m128i)B)           //zn:TODO  => OK
...
#define npyv_or_f32(A, B)   \
        (__m128)__lsx_vor_v((__m128i)A, (__m128i)B)           //zn:TODO  => OK
#define npyv_or_f64(A, B)   \
        (__m128d)__lsx_vor_v((__m128i)A, (__m128i)B)           //zn:TODO  => OK
...
#define npyv_xor_f32(A, B)   \
        (__m128)__lsx_vxor_v((__m128i)A, (__m128i)B)           //zn:TODO  => OK
#define npyv_xor_f64(A, B)   \
        (__m128d)__lsx_vxor_v((__m128i)A, (__m128i)B)           //zn:TODO  => OK
...
#define npyv_not_f32 (__m128)npyv_not_u8      //zn:TODO ==> OK
#define npyv_not_f64 (__m128d)npyv_not_u8            //zn:TODO ==> OK
...
#define npyv_xnor_b8 __lsx_vseq_b   //zn:TODO  == >OK
...
#define npyv_cmpeq_f64 __lsx_vfcmp_ceq_d     //zn:TODO 确认是否需要换成CUEQ- 1106
#define npyv_cmpneq_f32 __lsx_vfcmp_cune_s   //无法比较或不等-1106 is ok
...
{ return __lsx_vfcmp_cor_s(a, a); }    //zn:!nan 返回ffffffff
